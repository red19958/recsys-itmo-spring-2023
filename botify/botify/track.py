...
class Catalog:
    ...
    def upload_recommendations_neighbours(self, redis, recommendations_path="RECOMMENDATIONS_BY_ARTIST_NEIGHBOURS_FILE_PATH"):
        recommendations_file_path = self.app.config[recommendations_path]
        ...
        with open(recommendations_file_path) as rf:
            for line in rf:
                ...
                j += 1
        self.app.logger.info(f"Uploaded recommendations for {j} artist")
